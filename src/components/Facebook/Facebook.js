...
const Facebook = () => {
  const url = `https://www.facebook.com/v13.0/dialog/oauth?client_id=${APP_ID}&redirect_uri=${SELF_REDIRECT}&state=${STATE_PARAMS}&scope="email,public_profile"?path=${SELF_REDIRECT}`;
